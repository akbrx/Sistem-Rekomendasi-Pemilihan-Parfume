  ...
  return (
    <html lang="id">
      <body className={`${inter.className} bg-gray-50 flex flex-col min-h-screen text-gray-900`}>
        {/* Top Navbar */}
        <nav className="bg-gray-800 shadow-sm border-b border-gray-200 sticky top-0 z-50">
          <div className="w-full px-6 sm:px-10 lg:px-12">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex space-x-8">
                <Link href="/" className="text-white hover:text-indigo-400 font-medium transition duration-150">Home</Link>
                <Link href="/#edukasi" className="text-white hover:text-indigo-400 font-medium transition duration-150">Tentang</Link>
                <Link href="/rekomendasi" className="text-white hover:text-indigo-400 font-medium transition duration-150">Rekomendasi</Link>
              </div>
            </div>
          </div>
        </nav>
